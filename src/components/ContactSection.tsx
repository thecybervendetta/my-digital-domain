...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`mailto:richieace72@gmail.com?subject=${subject}&body=${body}`, "_blank");
    setSending(false);
    ...
    <section id="contact" className="py-24 relative">
      <div className="container mx-auto px-6">
        ...
        <ScrollReveal className="flex items-center justify-center gap-5 mt-10" delay={0.3}>
          ...
          <a href="https://github.com/Richieacey" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="w-12 h-12 rounded-xl glass flex items-center justify-center hover:border-primary/40 transition-all group gradient-border">
          ...
          <a href="mailto:richieace72@gmail.com" aria-label="Email" className="w-12 h-12 rounded-xl glass flex items-center justify-center hover:border-primary/40 transition-all group gradient-border">
