      ...
      <div className="container mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-5">
            ...
            <a href="mailto:hello@example.com" aria-label="Email" className="w-12 h-12 rounded-xl glass flex items-center justify-center hover:border-primary/40 transition-all group gradient-border">
