        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex items-center gap-5 mt-12 animate-fade-in-up-4">
              ...
              <a href="https://github.com/thecybervendetta" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="GitHub">
          ...
          <div className="hidden lg:flex justify-center animate-fade-in-up-2">
            <div className="relative">
              <div className="absolute -inset-4 rounded-2xl bg-primary/10 blur-2xl animate-pulse-ring" />
              <div className="relative glass rounded-2xl p-3 gradient-border">
                <img
                  src={heroPortrait}
                  alt="Richard Uwumwonse"
